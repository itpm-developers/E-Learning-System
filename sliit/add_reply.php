...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $action=mysqli_query($conn, " INSERT INTO add_reply(id, reply, file_name) VALUES ('$ename','$desc1','$fileName')");
...
<div class="col-md-offset-4">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#admins" data-toggle="tab" style="color:#337ab7;">Reply</a></li>
        <li><a href="#add" data-toggle="tab"style="color:#337ab7;">Add Reply</a> </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane active" id="admins"> <!-- Event Information-->
            <div class="col-md-9"><br>
                <table class="table table-bordered table-responsive">
                    ...
                    $conn = CreateConnection();
                    if($query = mysqli_query($conn, "SELECT * FROM add_reply")){
                        ...
                        if ($rows) {
                            while($dataRow = mysqli_fetch_array($query)){
                                ...
                                /*if($_SESSION["login_user"] != $dataRow["id"]) {
                                    echo "<a style='color: #122b40; text-decoration: dashed' onClick=\"javascript: return confirm('Please confirm deletion');\" href=delete_reply.php?id=" . $dataRow['id'] . ">Remove</a>";
                                }*/
                                echo "</td></tr></tbody>";
                            }
                        } else {
        ...
        <div class="tab-pane" id="add"><!-- Add reply-->
