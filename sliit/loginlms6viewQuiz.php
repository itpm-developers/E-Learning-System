...
if(isset($_SESSION['login_user'])){
    ...
    <head lang="en">
        ...
        <title>Find Your Quiz here</title>
    ...
    <div class="container" id="main">
        ...
        <div style="width:98%;align:center;">
            ...
            <div style="background-color:none;color:#663300;" class="include"><center>
                ...
                <h3><font color="#FFFFFF">Quizes</font></h3><br><hr><br><br>


                <table style="width: 500px; background-color: #008F77" class="table table-bordered">
                    <thead>
                    <tr>
                        <th><div style=color:#ffffff>Module Name</div></th>
                        <th><div style=color:#ffffff>File</div></th>
                    ...
                    if($query = mysqli_query($conn, "select * from add_quizes m")){
                        ...
                        if ($rows) {
                            while($dataRow = mysqli_fetch_array($query)){
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo "<a style='color: #122b40; text-decoration: dashed' href='uploads/".$dataRow['fileName']."'>".$dataRow['fileName']."</a>";
                                echo "</td>";
                                echo "<td>";
                            ...
                            echo "<tbody><tr><td colspan='4'><div style=color:red; font-weight: bold>No Files Uploaded</td></tr></tbody></div>";
                        }
