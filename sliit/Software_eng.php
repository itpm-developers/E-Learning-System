...
<div class="container" id="main">
    ...
    <div class="pager">
        <div class="container" style="position: relative; text-align: center">
            <div class="top-left" style="position: absolute; font-family:Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 40px; color: white">

                <h1>Software Engineering</h1>
                <br> Engineering is the processes of <br>designing and building something that serves <br>
                a particular <br>purpose and find a cost effective solution <br> to problems.
                <br> Software Engineering is a systematic approach to <br>
