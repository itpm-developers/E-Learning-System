    ...
    <div class="pager">
        <div class="container" style="position: relative; text-align: center">
            <div class="top-left" style="position: absolute; font-family:Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 40px; color: #fdfdfe">
                ...
                <h1>Java Course</h1>
                Java is one of the world’s most popular programming languages. <br>Fortune 500 companies and <br>
                Android app developers alike <br> love Java for its relative simplicity and portability.
                <br>Plus, Java was designed<br> to be a more approachable alternative <br> to complex languages like C++
            </div>
