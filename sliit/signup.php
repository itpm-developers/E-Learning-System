        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading"  style="background-color:#008F77;color:floralwhite;"><strong>Enter Following Details For Sign up</strong></div>
                    <div class="panel-body" style="background-color:azure;">
                                    ...
                                    else
                                    {
                                        if($password == $repass)
                                        {
                                            if(user_exist($email)== false)
                                            {
                                                ...
                                                $action=mysqli_query($conn, "INSERT INTO student_signup (f_name, l_name, email, password, faculty, course, batch, `index_no`, `date`, `active`) VALUES ('$fname', '$lname', '$email','$password','$faculty','$course','$batch','$index','$date',0)");
                                                    echo "<div style=color:red; font-weight: bold>Successfully Register</div>";
                                            }
                                            else
                                            {
                        ...
                        <form class="form-horizontal" method="post" role="form" action="signup.php" >
                            ...
                            <br>
                            <label>Address:</label>
                            <input type="text" class="form-control" name="index" placeholder="Example:- 15.1 001" >
                            <br>
                            <label>E Mail:</label>
                            ...
                            <input type="submit" name="submit" value="Sign Up" class="btn btn-default"style="background-color:#008F77;color:floralwhite;">
                        </form>
                    </div>
                </div>
            </div>
